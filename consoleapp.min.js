...
function(a){a.onError("No onCommand handler registered.")};a.onError=b.onError||function(d){a.println(d.toString(),b.errorTextStyle)};a.consoleMode=function(){try{if(a.currentMode="console",l.className="hidden",e.className="",a.enable(),a.onConsoleMode)a.onConsoleMode()}catch(d){a.onError(d)}};a.editMode=function(){try{if(a.currentMode="edit",e.className="hidden",l.className="",g.focus(),a.onEditMode)a.onEditMode()}catch(d){a.onError(d)}};a.enable=function(){h.className="";c.disabled=!1;c.focus()};
a.disable=function(){h.className="hidden";c.disabled=!0};a.print=function(a,b){var d=document.createElement("span");d.appendChild(document.createTextNode(a));b&&(d.style=b);k.appendChild(d)};a.println=function(b,c){a.print(b+"\n",c)};a.clear=function(){for(;k.firstChild;)k.removeChild(k.firstChild)};a.setPrompt=function(a,c){for(;f.firstChild;)f.removeChild(f.firstChild);b.prompt=a;f.appendChild(document.createTextNode(a));c&&(f.style=c)};a.consoleMode();a.setPrompt(b.prompt)};